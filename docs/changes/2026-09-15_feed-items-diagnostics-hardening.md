...
- Replace rigid `select_xcode_26_5.sh` with `tool/select_xcode.sh` (CI newest
  released ≥ 26.5; local newest install including seed). Keep
  `select_xcode_26_5.sh` as a thin wrapper.
