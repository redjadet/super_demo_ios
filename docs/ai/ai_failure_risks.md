...
| P1 — during implementation | Layers, MainActor, SwiftData, tests, universal UI | `RISK-ARCH-LAYER`, `RISK-MAINACTOR`, `RISK-SWIFTDATA`, `RISK-UNIVERSAL-UI`, `RISK-VALIDATION-SHORTCUT` |
