...
| Layer | What runs |
| --- | --- |
| **GitHub Actions** | `.github/workflows/ci.yml` - Swift lint, build, test on `macos-26` with **Xcode 26.5+** via `tool/select_xcode.sh` (prefers 26.6 then 26.5). Local README documents **Xcode 27 / Swift 6.4**. |
